class ManifestManager {
  ...
  createSampleStats() {
    ...
    const statDefinitions = [
      { hash: 2996146975, name: "Mobility", description: "Increases your movement speed and maximum jump height" },
      { hash: 392767087, name: "Resilience", description: "Increases the amount of damage you can take before dying" },
      { hash: 1943323491, name: "Recovery", description: "Increases the speed at which you regain lost health" },
      { hash: 1735777505, name: "Discipline", description: "Decreases the cooldown time of your grenades" },
      { hash: 144602215, name: "Intellect", description: "Decreases the cooldown of your Super ability" },
      { hash: 4244567218, name: "Strength", description: "Decreases the cooldown time of your melee ability" }
    ]

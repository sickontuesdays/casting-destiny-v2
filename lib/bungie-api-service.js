...
class BungieAPIService {
  ...
  async getDestinyMemberships(accessToken) {
    ...
    const primaryMembership = userInfo.primaryMembershipId
    
    let selectedMembership = destinyMemberships.find(m => m.membershipId === primaryMembership)

...
// Singleton function for consistent usage pattern (matches GitHub storage pattern)
let clientManifestLoaderInstance = null

export function getClientManifestLoader(accessToken = null) {
  if (!clientManifestLoaderInstance) {
    clientManifestLoaderInstance = new ClientManifestLoader(accessToken)
  } else if (accessToken && accessToken !== clientManifestLoaderInstance.accessToken) {
    clientManifestLoaderInstance.setAccessToken(accessToken)
  }
  
  return clientManifestLoaderInstance
}
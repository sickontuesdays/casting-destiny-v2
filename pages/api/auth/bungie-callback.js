// pages/api/auth/bungie-callback.js
// Handles OAuth callback from Bungie with proper error handling
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const cookieOptions = [
      `bungie_session=${sessionToken}; HttpOnly; Secure=${isProduction}; SameSite=Lax; Path=/; Max-Age=${7 * 24 * 60 * 60}`,
      // Clear the state cookie
      `oauth_state=; HttpOnly; Secure=${isProduction}; SameSite=Lax; Path=/; Max-Age=0`
    ]
